The repo contains all data and different analytic approaches that can be used to look at a problem. The project was to create a dashboard, PowerPoint, Blog post, 
